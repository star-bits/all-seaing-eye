img_scale = (3840//5, 2160//5)
max_epochs = 50
samples_per_gpu = 16
workers_per_gpu = 16
work_dir = '../work_dirs/all-seaing-eye'
seed = 42
gpu_ids = [0]
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='All-SEAing Eye', name='swin_faster'))
    ])
